...
entrega : clean
	@(tar cf ../dmutex.2013b.entrega.tar Proceso ; \
	rm -f ../dmutex.2013b.entrega.tar.gz ; \
	gzip -9 ../dmutex.2013b.entrega.tar  ; \
	mv ../dmutex.2013b.entrega.tar.gz .  ; \
	echo "Fichero de entrega generado dmutex.2013b.entrega.tar.gz")
